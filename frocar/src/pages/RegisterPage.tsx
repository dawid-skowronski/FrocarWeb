...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        let errorMessage = data.message || "Wystąpił błąd podczas rejestracji. Spróbuj ponownie.";
        if (data.message === "Username is already taken") {
          ...
          errorMessage = "Podany adres email jest już używany.";
        }
  ...
  return (
      ...
      >
        <motion.div
          ...
          style={{ width: "400px", background: "rgba(255, 255, 255, 0.8)" }} // Lekko przezroczysta karta
        >
          <h2 className="text-center text-success mb-4">Rejestracja</h2>
